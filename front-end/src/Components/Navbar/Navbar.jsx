  ...
  return (
    <nav className="navbar">
      <div className="navbar-logo-container">
        ...
        <h1 className="navbar-title">RUR</h1>
      </div>
        ...
        <div className="navbar-links">
          <div className="navbar-dropdown">
            ...
            <div className={`dropdown-content ${categoryDropdownVisible ? 'show' : ''}`}>
              <Link to="/category/AGE 3-6" onClick={handleLinkClick}>Men's Collection</Link>
              <Link to="/category/AGE 7-10" onClick={handleLinkClick}>Women's Collection</Link>
              <Link to="/category/ABOVE 10" onClick={handleLinkClick}>Party Wear</Link>
            </div>
          </div>
          <Link to="/books" className="navbar-link">Bridal</Link>
          {/* <Link to="/new-arrival" className="navbar-link">New Arrival</Link> */}
          <Link to="/portal" className="navbar-link">Cart</Link>
        </div>
      </div>
